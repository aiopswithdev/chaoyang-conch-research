...
UNI_TEST_CACHE = "/home/d3vd5k/projects/DL/conch+uni/extracted_features/uni_test_features.pt"
RESULTS_DIR    = "/home/d3vd5k/projects/DL/conch+uni/using_cached_UNI/dev_phase_1_2/results_lora_advanced"
CHECKPOINT_PATH = os.path.join(RESULTS_DIR, "best_f1.pt")
OUTPUT_FILE    = os.path.join(RESULTS_DIR, "bi_attn_dynamic_feature_wt_results.txt")
...
def main():
    ...
    out = []
    out.append("="*60)
    out.append(" 📊 DETAILED TEST SET STATISTICS")
    out.append("="*60)
